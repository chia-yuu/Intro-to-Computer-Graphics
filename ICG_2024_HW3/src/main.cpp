...
void render(){
    ...
    shaderPrograms[shaderProgramIndex]->set_uniform_value("materialGloss", material.gloss);
...
int main() {
    ...
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "HW3-111550108", NULL, NULL);
    if (window == NULL) {
